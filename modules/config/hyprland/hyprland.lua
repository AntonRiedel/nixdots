...
-- cycle clients (dwm-like)
hl.bind(mod .. " + J", hl.dsp.layout("cyclenext loop"))
hl.bind(mod .. " + K", hl.dsp.layout("cycleprev loop"))
-- resize master area
hl.bind(mod .. " + H", hl.dsp.layout("mfact -0.05"))
hl.bind(mod .. " + L", hl.dsp.layout("mfact +0.05"))
-- move windows
hl.bind(mod .. " + SHIFT + J", hl.dsp.layout("swapnext loop"))
hl.bind(mod .. " + SHIFT + K", hl.dsp.layout("swapprev loop"))
-- make new master
...
hl.bind(mod .. " + SHIFT + G", smw.grab_rogue_windows())
